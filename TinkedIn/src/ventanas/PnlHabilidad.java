...
//		modeloLista = new DefaultListModel<Habilidad>();
		...
		btnListaEliminar.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if (listaHabilidades.getSelectedValue() != null) {
					Habilidad habilidad = listaHabilidades.getSelectedValue();
					VentanaPrincipal.servicio.eliminarHabilidad(habilidad,PnlBotonera.usuarioAutenticado.getId());
					modeloLista.removeElement(habilidad);
					listaHabilidades.repaint();
				}
			}
		});
		...
		btnAñadirHab.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (tree.getLastSelectedPathComponent() != null) {
					String habilidad = JOptionPane.showInputDialog(" Introduce la habilidad que deseas añadir a "
